params ["_target", "_player","_containerList"];
private _items = [];
private _backpacks = [];
private _isMan = false;
private _weight = 0;
systemChat format["1Tac Antistasi Looter: Moving from %1 containers to %2",count(_containerList),getText (configFile >> "CfgVehicles" >> typeOf _target >> "displayname")];
