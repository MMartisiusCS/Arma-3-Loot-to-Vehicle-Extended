...
private _actionVehicle = [
    "LootToVehicleExtended_transferActionVehicle", "Transfer Loot to Vehicle", "a3\ui_f\data\IGUI\Cfg\Actions\loadVehicle_ca.paa",
    {
        params ["_target", "_player"];
    ...
    {}] call ace_interact_menu_fnc_createAction;
["Car", 0, ["ACE_MainActions"], _actionVehicle, true] call ace_interact_menu_fnc_addActionToClass;